...
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,import { useRef, useState } from "react";
import { Loader, LogOut, MoveLeft } from "lucide-react";
import { Link, useNavigate } from "react-router-dom";
import {
  HoverCard,
          ...
          <HoverCard>
            ...
            <HoverCardContent className="px-0 w-auto">
              ...
              <div className="flex items-center flex-col gap-2 mt-4 text-white">
                {/* check out proceed */}
                <button disabled={loading || total === 0} onClick={openPopup}   className="w-[87%]  py-4 bg-orange-500 hover:bg-orange-400 active:bg-orange-500 flex justify-center items-center  gap-3 ">
